...
pub fn write_ik5(ik5: IK5) -> String {
    ...
    if !ik5
        .ik502_implementation_transaction_set_syntax_error_code
        .is_empty()
    {
        ...
        if !ik5
            .ik503_implementation_transaction_set_syntax_error_code
            .is_empty()
        {
            ik5_content.push_str("*");
            ...
            if !ik5
                .ik504_implementation_transaction_set_syntax_error_code
                .is_empty()
            {
                ik5_content.push_str("*");
                ...
                if !ik5
                    .ik505_implementation_transaction_set_syntax_error_code
                    .is_empty()
                {
                    ik5_content.push_str("*");
                    ik5_content
                        .push_str(&ik5.ik505_implementation_transaction_set_syntax_error_code);

                    if !ik5
                        .ik506_implementation_transaction_set_syntax_error_code
                        .is_empty()
                    {
                        ik5_content.push_str("*");
                        ik5_content
                            .push_str(&ik5.ik506_implementation_transaction_set_syntax_error_code);
                    }
                }
            }
        }
...
mod tests {
    ...
    fn test_get_ik5() {
        ...
        assert_eq!(
            ik5.ik502_implementation_transaction_set_syntax_error_code,
            "1"
        );
        assert_eq!(
            ik5.ik503_implementation_transaction_set_syntax_error_code,
            "2"
        );
        assert_eq!(
            ik5.ik504_implementation_transaction_set_syntax_error_code,
            "3"
        );
        assert_eq!(
            ik5.ik505_implementation_transaction_set_syntax_error_code,
            "4"
        );
        assert_eq!(
            ik5.ik506_implementation_transaction_set_syntax_error_code,
            "5"
        );
    }
