...
pub fn get_276(contents: &str) -> EdiResult<Edi276> {
...
mod tests {
    ...
    fn test_parse_and_generate_276() {
        ...
        let sample_edi = "ISA*00*          *00*          *ZZ*SENDER         *ZZ*RECEIVER       *230501*1200*^*00501*000000001*0*P*:~\
                          ...
                          BHT*0010*13*12345*20230501*1200*13~\
                          HL*1**20*1~\
        ...
        // Parse the EDI file
        let edi276_result = get_276(sample_edi);
        ...
        assert_eq!(
            edi276.table1_combined.table1.bht06_transaction_type_code,
            "13"
        ); // 13 is for Request
        ...
        assert!(
            generated_edi.contains("BHT*0010*13*"),
            "Missing BHT segment"
        );
        assert!(
        ...
        // TODO: TRN, REF, DMG not yet written - Loop2000C/D parsing not implemented
    ...
    fn test_loop_structure_276() {
        ...
        loop_2000a.nm1 = NM1 {
            ...
            suffix: None,
            title: None,
            id_code_qualifier: Some("PI".to_string()),
            id_code: Some("12345".to_string()),
            member_number: None,
        };
        ...
        loop_2000d.nm1 = NM1 {
            ...
            id_code: Some("12345678901".to_string()),
            member_number: None,
        };
        loop_2000d.trn = TRN {
        ...
        assert!(
            loop_2000a_edi.contains("HL*1**20*1~"),
            "Incorrect HL segment for Information Source"
        );
        assert!(
            loop_2000a_edi.contains("NM1*PR*2*INSURANCE COMPANY"),
            "Incorrect NM1 segment for Information Source"
        );
    }
    ...
    fn test_is_276_json() {
        ...
        assert!(
            !is_276_json(invalid_json),
            "Incorrectly identified invalid JSON as 276"
        );
    }
}
