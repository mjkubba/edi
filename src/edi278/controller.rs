    ...
    fn parse(contents: String) -> EdiResult<(Self, String)> {
        ...
        if loop2000e.hl_segments.hl01_hierarchical_id_number != "" {
            ...
            if !loop2100e.dtp_segments.is_empty()
                ...
                || loop2100e.cl1_segments.is_some()
            {
...
IEA*1*000000001~";
        ...
        assert_eq!(
            edi278.interchange_header.isa_segments.sender_id,
            "SUBMITTER      "
        );
        assert_eq!(
            edi278.interchange_header.gs_segments.app_sender_id,
            "SUBMITTER"
        );
        assert_eq!(
            edi278.table1_combined.table1.st_segments.transaction_set_id,
            "278"
        );
        assert_eq!(
            edi278
                ...
                .table1
                .bht_segments
                .bht03_reference_identification,
            "123456"
        );
        ...
        assert_eq!(
            edi278.interchange_trailer.se_segments.number_of_segment,
            "10"
        );
    }
...
IEA*1*000000001~";
        ...
        assert_eq!(
            loop2010f.prv_segments.as_ref().unwrap().prv01_provider_code,
            "PE"
        );
...
IEA*1*000000001~";
        ...
        assert!(generated.contains(
            "ISA*00*          *00*          *ZZ*SUBMITTER      *ZZ*RECEIVER       *200101*1200"
        ));
