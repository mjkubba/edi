...
pub fn get_loop2000c(contents: &str) -> (Loop2000C, String) {
...
mod tests {
    ...
    fn test_get_loop2000c() {
        ...
        assert_eq!(
            loop2000c.hl_segments.hl02_hierarchical_parent_id_number,
            "2"
        );
        ...
        assert_eq!(
            loop2000c.trn_segments[0].originating_company_id,
            "1512345678"
        );
