...
mod tests {
    ...
    fn test_get_table1s() {
        ...
        assert_eq!(
            table1s.bht_segments.bht01_hierarchical_structure_code,
            "0007"
        );
        assert_eq!(
            table1s.bht_segments.bht02_transaction_set_purpose_code,
            "11"
        );
        assert_eq!(
            table1s.bht_segments.bht03_reference_identification,
            "123456"
        );
        assert_eq!(contents, "");
    }
