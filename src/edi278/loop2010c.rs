...
pub fn get_loop2010c(contents: &str) -> (Loop2010C, String) {
...
mod tests {
    ...
    fn test_get_loop2010c() {
        let contents =
            String::from("NM1*IL*1*DOE*JOHN****MI*123456789A~REF*SY*123456789~DMG*D8*19800519*M~");
        ...
        assert_eq!(
            loop2010c.ref_segments[0].reference_id_number_qualifier,
            "SY"
        );
